  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 bg-white rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-3">School Branch Management</h1>
        <p className="text-gray-500 mb-8 leading-relaxed">
          The School Branch details are being processed and integrated with our branch-level access control tables.
        </p>
